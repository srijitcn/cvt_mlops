...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-cvt_mlops_stacks_demo-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.cvt.cvt_mlops_stacks_demo-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.cvt.trip_pickup_features",
