...
```
cvt_mlops        <- Root directory. Both monorepo and polyrepo are supported.
│
├── cvt_mlops_stacks_demo       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
