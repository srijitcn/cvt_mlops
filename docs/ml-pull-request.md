...
Opening a pull request will trigger a[workflow](../.github/workflows/cvt_mlops_stacks_demo-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://adb-8590162618558854.14.azuredatabricks.net#mlflow/models/staging-cvt_mlops_stacks_demo-model)
* [Prod workspace registered model](https://adb-8590162618558854.14.azuredatabricks.net#mlflow/models/prod-cvt_mlops_stacks_demo-model)
